...
file_path = "C:\\ChatBotImplementationUsingNLP-main\\ChatBotImplementationUsingNLP-main\intents.json"
...
def main():
    ...
    # Conversation History Menu
        ...
        - Entities: The entities extracted from user input (e.g. "Hi", "Can i book an appointment", "Where can i see my prescriptions?")
